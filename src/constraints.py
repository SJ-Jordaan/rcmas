...
from .config import NEUTRAL_SECTORS, NUM_SECTORS, NUM_AGENTS, NUM_TIMESTEPS, GRID_HEIGHT, GRID_WIDTH
from .utils import (
...
def generate_evolution_constraints():
    ...
    unchanged_sector_constraints = for_all_timesteps_and_sectors(
        lambda t, sector_id: Implies(
            And(for_all_agents(lambda agt: Int(f"action_{agt}_{t}") != sector_id)),
...
def generate_conflict_constraints():
    ...
    """
    from .utils import for_all_timesteps_and_sectors, for_all_agent_pairs
